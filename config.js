...
config.time = {
	"localzone": "Asia/Vladivostok",
	"remotezone": "Europe/Moscow"
};
config.cam = {
...
config.weather = {
    ...
    "key": "52a60ba0782a5521b47b780aeeeb72ac",
    "url": "http://api.openweathermap.org/data/2.5/weather?lang=" + config.language1 + "&lat=" + config.location.lat + "&lon=" + config.location.lng + "&APPID=",
	},
	"met_no": {
